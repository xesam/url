...
describe('url', () => {
    ...
    test('when url is a blank string then return all undefined', () => {
        const urls = url('  ');
        expect(urls).toStrictEqual({
            protocol: undefined,
            auth: undefined,
    ...
    test('when url is {protocol}://{hostname} then return all undefined', () => {
    ...
    test('when url is {protocol}://{hostname}:{port} then return protocol、hostname', () => {
    ...
    test('when url is {protocol}://{name}:{password}@{hostname}:{port} then return protocol、auth、hostname、port', () => {
    ...
    test('when url is {protocol}://{name}:{password}@{hostname}:{port}{path} then return protocol、auth、hostname、port、path', () => {
    ...
    test('when url is {protocol}://{name}:{password}@{hostname}:{port}{path}?{query} then return protocol、auth、hostname、port、query', () => {
        const urls = url('https://admin:root@xesam.github.io:80/abc/def?name=xesam');
        expect(urls).toStrictEqual({
            protocol: 'https:',
            auth: 'admin:root',
            host: 'xesam.github.io:80',
    ...
    test('when url is {search} then return search、query', () => {
        const urls = url('?');
        expect(urls).toStrictEqual({
            protocol: undefined,
            auth: undefined,
